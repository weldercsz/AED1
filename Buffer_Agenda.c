...
int main()
{
  ...
  //Ideias iniciais , para manipulação da Memoria e alocação Dinamica
  //1 numero de elementos, 2-controle repetidos 1, 3-controle repetidoo 2,
  //4-controle escolha, 5-espaco para nome temporario, 6-espaço para numero temporario
  *(int *)pBuffer = 0;
  for (;;)
  {
    ...
    printf("AGENDA:Algoritimo e Estrutura de Dados I.\n");
    printf("1-Inserir\n");
    printf("2-Buscar\n");
    printf("3-Apagar\n");
    printf("4-Listar\n");
...
// Inserindo elementos de Ordenação na Agenda de Buffer
...
/* // Ainda em Desenvolvimento -> tentar na Monitoria 
